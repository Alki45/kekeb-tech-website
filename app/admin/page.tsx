...
export default function AdminDashboard() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (loginData.username === "admin" && loginData.password === "kokeb2024") {
      setIsAuthenticated(true)
    } else {
      alert("Invalid credentials! Use: admin / kokeb2024")
    }
  }
        ...
        <Card className="w-full max-w-md bg-white/10 backdrop-blur-md border-white/20 text-white relative z-10">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <CardTitle className="text-2xl font-bold">Kokeb Tech Solutions Admin</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-blue-200 mt-4 text-center">Demo: admin / kokeb2024</p>
          </CardContent>
        </Card>
      </div>
    )
      ...
      <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 shadow-lg">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold">Kokeb Tech Solutions Admin Dashboard</h1>
          </div>
