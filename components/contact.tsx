...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email Address",
      details: ["info@kokebtechsolutions.com  ", "support@kokebtechsolutions.com  "],
      action: () => handleQuickEmail("info@kokebtechsolutions.com"),
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
                          ...
                          {info.title === "Phone Numbers" ? (
                            ...
                            <div className="space-y-1">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation()
                                  handleQuickEmail("info@kokebtechsolutions.com")
                                }}
                                className="block text-gray-600 text-sm hover:text-blue-600 transition-colors text-left"
                              >
                                info@kokebtechsolutions.com  
                              </button>
                              <button
                                onClick={(e) => {
                                  e.stopPropagation()
                                  handleQuickEmail("support@kokebtechsolutions.com  ")
                                }}
                                className="block text-gray-600 text-sm hover:text-blue-600 transition-colors text-left"
                              >
                                support@kokebtechsolutions.com  
                              </button>
                            </div>
                          ) : (
              ...
              <div className="mt-6 space-y-3">
                ...
                <Button onClick={() => handleQuickEmail("info@kokebtechsolutions.com")} variant="outline" className="w-full">
