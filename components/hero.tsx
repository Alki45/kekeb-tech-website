...
export default function Hero() {
  ...
  const handleEmailClick = useCallback(() => {
    window.location.href = "mailto:info@kokebtechsolutions.com"
  }, [])
        ...
        <div className="text-center max-w-6xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="relative">
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl text-blue-200 mt-2 font-light">
                    ኮከብ • Your Digital Constellation
                  </p>
                </div>
              </div>
          ...
          >
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-8 leading-relaxed max-w-4xl mx-auto">
              Kokeb Tech Solutions illuminates your path to technological excellence with comprehensive IT solutions
