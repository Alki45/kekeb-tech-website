        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Named after the Amharic word for 'star,' Kokeb Tech Solutions serves as your guiding light in the vast
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="space-y-1">
                  <p className="text-gray-300">+251 919 312 559</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="space-y-1">
                  <p className="text-gray-300">info@kokebtechsolutions.com  </p>
                  <p className="text-gray-400 text-sm">Support@kokebtechsolutions.com  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-gray-400">© {currentYear} Kokeb Tech Solutions. All rights reserved.</p>
