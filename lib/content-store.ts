...
export const leadership = [
  {
    ...
    bio: "Leading Kokeb Tech Solutions with a vision to transform the Ethiopian technology landscape and guide businesses toward digital excellence. As both CEO and AI Trainee Software Developer, combining strategic leadership with hands-on technical expertise in emerging technologies.",
    expertise: [
      "Strategic Planning",
  ...
  },
  {
    ...
    bio: "Driving technical innovation and overseeing all technology initiatives at Kokeb Tech Solutions. Expert in software development and emerging technologies with a passion for creating scalable solutions that meet modern business needs.",
...
export const aboutContent = {
  title: "About Kokeb Tech Solutions",
  description:
    'Named after the Amharic word for "star," Kokeb Tech Solutions serves as your guiding light in the vast universe of technology, illuminating the path to digital transformation.',
  mission:
